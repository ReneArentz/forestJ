...
public class JSONTest {
	...
	public void testJSON() {
		try {
			...
			String s_testDirectory = s_currentDirectory + de.forestj.lib.io.File.DIR + "testJSON" + de.forestj.lib.io.File.DIR;
	...
	private static void jsonValidate() throws Exception {
		String s_jsonSchemaFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "TestJSONSchemaClassRootWithRef.json";
		String s_jsonFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "ValidateJSON.json";
		String s_invalidJsonFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "ValidateJSONIsInvalid.json";
		
		assertTrue(
				new de.forestj.lib.io.JSON(s_jsonSchemaFile).validateAgainstSchema(s_jsonFile),
		...
		try {
			assertFalse(
					new de.forestj.lib.io.JSON(s_jsonSchemaFile).validateAgainstSchema(s_invalidJsonFile),
	...
	private static void jsonVirtualFiles(String p_s_testDirectory, String p_s_fileNameSuffix) throws Exception {
		...
		de.forestj.lib.io.JSON o_jsonEmpty = new de.forestj.lib.io.JSON();
		de.forestj.lib.io.JSON.JSONElement o_jsonSchema = o_jsonEmpty.new JSONElement("Root");
		o_jsonSchema.setType("object");
		o_jsonSchema.setMappingClass("de.forestj.lib.test.sql.AllTypesRecord");
		
			de.forestj.lib.io.JSON.JSONElement o_jsonElement = o_jsonEmpty.new JSONElement("Id");
		...
		de.forestj.lib.io.JSON o_json = new de.forestj.lib.io.JSON(o_jsonSchema);
		...
		de.forestj.lib.test.sql.AllTypesRecord o_recordIn = (de.forestj.lib.test.sql.AllTypesRecord)o_json.jsonDecode(a_fileLines);
		
		assertTrue(
				de.forestj.lib.Helper.objectsEqualUsingReflections(o_recordOut, o_recordIn, o_json.getUsePropertyMethods()),
		...
		o_recordIn = (de.forestj.lib.test.sql.AllTypesRecord)o_json.jsonDecode(a_fileLines);
	...
	private static void jsonObject(String p_s_testDirectory, String p_s_fileNameSuffix) throws Exception {
		...
		de.forestj.lib.io.File o_fileSimpleClass = o_json.jsonEncode(o_recordOut, s_fileSimpleClass, true);
		
		de.forestj.lib.test.sql.AllTypesRecord o_recordIn = (de.forestj.lib.test.sql.AllTypesRecord)o_json.jsonDecode(s_fileSimpleClass);
	...
	private static void jsonClass(String p_s_testDirectory, String p_s_jsonSchemaFileName, String p_s_fileNameSuffix) throws Exception {
		...
		String s_jsonSchemaFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + p_s_jsonSchemaFileName;
		de.forestj.lib.io.JSON o_json = new de.forestj.lib.io.JSON(s_jsonSchemaFile);
	...
	private static void jsonArray(String p_s_testDirectory, String p_s_jsonSchemaFileName, String p_s_fileNameSuffix) throws Exception {
		...
		if (p_s_jsonSchemaFileName.contentEquals("TestJSONSchemaSimpleClassArray.json")) {
			@SuppressWarnings("unused")
			de.forestj.lib.io.File o_fileSimpleClass = o_json.jsonEncode(a_dataOut, s_fileSimpleClass, true);
		} else {
			@SuppressWarnings("unused")
			de.forestj.lib.io.File o_fileSimpleClass = o_json.jsonEncode(o_collectionOut, s_fileSimpleClass, true);
		}
		...
		if (!p_s_jsonSchemaFileName.contentEquals("TestJSONSchemaSimpleClassArray.json")) {
			assertTrue(
					de.forestj.lib.Helper.objectsEqualUsingReflections(o_collectionOut, o_collectionIn, o_json.getUsePropertyMethods()),
					"output object inner class collection is not equal to input object inner class collection"
					);
		}
		
		assertTrue(
				de.forestj.lib.Helper.objectsEqualUsingReflections(a_dataOut, a_dataIn, o_json.getUsePropertyMethods()),
				"output object inner class array is not equal to input object inner class array"
				);
		
		for (int i = 0; i < a_dataOut.size(); i++) {
			assertTrue(
					de.forestj.lib.Helper.objectsEqualUsingReflections(a_dataOut.get(i), a_dataIn.get(i), o_json.getUsePropertyMethods(), true),
	...
	private static void jsonComplex(String p_s_testDirectory, boolean p_b_classRoot, boolean p_b_listRoot, boolean p_b_classRootWithRef, boolean p_b_listRootWithRef, String p_s_fileNameSuffix) throws Exception {
		...
		if (p_b_classRoot) {
			s_jsonSchemaFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "TestJSONSchemaClassRoot.json";
		} else if (p_b_listRoot) {
			s_jsonSchemaFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "TestJSONSchemaListRoot.json";
		} else if (p_b_classRootWithRef) {
			s_jsonSchemaFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "TestJSONSchemaClassRootWithRef.json";
		} else if (p_b_listRootWithRef) {
			s_jsonSchemaFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "TestJSONSchemaListRootWithRef.json";
		}
		...
		if ( (p_b_classRoot) || (p_b_classRootWithRef) ) {
			@SuppressWarnings("unused")
			de.forestj.lib.io.File o_file = o_json.jsonEncode(o_shipOrderCollectionOut, s_file, true);
		} else {
			@SuppressWarnings("unused")
			de.forestj.lib.io.File o_file = o_json.jsonEncode(a_shipOrdersOut, s_file, true);
		}
		...
		if ( (p_b_classRoot) || (p_b_classRootWithRef) ) {
			assertTrue(
					de.forestj.lib.Helper.objectsEqualUsingReflections(o_shipOrderCollectionOut, o_shipOrderCollectionIn, o_json.getUsePropertyMethods()),
					"output object inner class collection is not equal to input object inner class collection"
					);
		}
		
		assertTrue(
				de.forestj.lib.Helper.objectsEqualUsingReflections(a_shipOrdersOut, a_shipOrdersIn, o_json.getUsePropertyMethods()),
				"output object inner class array is not equal to input object inner class array"
				);
		
		for (int i = 0; i < a_shipOrdersIn.size(); i++) {
			assertTrue(
					de.forestj.lib.Helper.objectsEqualUsingReflections(a_shipOrdersOut.get(i), a_shipOrdersIn.get(i), o_json.getUsePropertyMethods(), true),
					"output object inner class array element object is not equal to input object inner class array element object"
					);
		...
		if (p_b_listRootWithRef) {
			s_file = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "TestJSONPrimitiveArrayOneLine.json";
	...
	private static void jsonMultipleUseOfOneSchemaObject(String p_s_testDirectory) throws Exception {
		...
		String s_jsonSchemaFile = de.forestj.lib.io.File.getCurrentDirectory() + de.forestj.lib.io.File.DIR + "src" + de.forestj.lib.io.File.DIR + "test" + de.forestj.lib.io.File.DIR + "resources" + de.forestj.lib.io.File.DIR + "json" + de.forestj.lib.io.File.DIR + "TestJSONSchemaSimpleClassObjectMultiReferences.json";
		de.forestj.lib.io.JSON o_json = new de.forestj.lib.io.JSON(s_jsonSchemaFile);
		...
		o_json = new de.forestj.lib.io.JSON(s_jsonSchemaFile);
		o_json.setUsePropertyMethods(true);
