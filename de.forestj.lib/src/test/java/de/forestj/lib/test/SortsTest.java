...
public class SortsTest {
	...
	private static void executeSortsList(boolean p_b_unique, int p_i_amount, boolean p_b_selection, boolean p_b_insertion, boolean p_b_bubble, boolean p_b_heap, boolean p_b_merge, boolean p_b_quick) {
		...
		if (p_b_selection) {
			...
			de.forestj.lib.Sorts.selectionSort(a_list);
		...
		if (p_b_insertion) {
			java.util.Collections.shuffle(a_list);
			de.forestj.lib.Sorts.insertionSort(a_list);
			executeSortsListValidate(p_b_unique, a_list);
		}
		...
		if (p_b_bubble) {
			java.util.Collections.shuffle(a_list);
			de.forestj.lib.Sorts.bubbleSort(a_list);
			executeSortsListValidate(p_b_unique, a_list);
		}
		...
		if (p_b_heap) {
			java.util.Collections.shuffle(a_list);
			de.forestj.lib.Sorts.heapSort(a_list);
			executeSortsListValidate(p_b_unique, a_list);
		}
		...
		if (p_b_merge) {
			java.util.Collections.shuffle(a_list);
			de.forestj.lib.Sorts.mergeSort(a_list);
			executeSortsListValidate(p_b_unique, a_list);
		}
		...
		if (p_b_quick) {
			java.util.Collections.shuffle(a_list);
			de.forestj.lib.Sorts.quickSort(a_list);
			executeSortsListValidate(p_b_unique, a_list);
		}
	}
	...
	private static void executeSortsMap(boolean p_b_unique, int p_i_amount, boolean p_b_selection, boolean p_b_insertion, boolean p_b_bubble, boolean p_b_heap, boolean p_b_merge, boolean p_b_quick, boolean p_b_sortByValue) {
		...
		if (p_b_selection) {
			...
			a_return = de.forestj.lib.Sorts.selectionSort(a_map, p_b_sortByValue);
		...
		if (p_b_insertion) {
			...
			a_return = de.forestj.lib.Sorts.insertionSort(a_map, p_b_sortByValue);
			executeSortsMapValidate(p_b_unique, p_b_sortByValue, a_return);
		}
		...
		if (p_b_bubble) {
			...
			a_return = de.forestj.lib.Sorts.bubbleSort(a_map, p_b_sortByValue);
			executeSortsMapValidate(p_b_unique, p_b_sortByValue, a_return);
		}
		...
		if (p_b_heap) {
			...
			a_return = de.forestj.lib.Sorts.heapSort(a_map, p_b_sortByValue);
			executeSortsMapValidate(p_b_unique, p_b_sortByValue, a_return);
		}
		...
		if (p_b_merge) {
			...
			a_return = de.forestj.lib.Sorts.mergeSort(a_map, p_b_sortByValue);
			executeSortsMapValidate(p_b_unique, p_b_sortByValue, a_return);
		}
		...
		if (p_b_quick) {
			...
			a_return = de.forestj.lib.Sorts.quickSort(a_map, p_b_sortByValue);
			executeSortsMapValidate(p_b_unique, p_b_sortByValue, a_return);
		}
	}
