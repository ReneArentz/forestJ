...
public class DijkstraTest {
	...
	public void testDijkstra() {
		...
		de.forestj.lib.Dijkstra<Integer> o_graphInteger = new de.forestj.lib.Dijkstra<Integer>();
		...
		de.forestj.lib.Dijkstra<String> o_graph = new de.forestj.lib.Dijkstra<String>();
