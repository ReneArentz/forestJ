...
public class LoggingConfig {
	...
	public void setLevel(java.util.logging.Level p_e_value) throws IllegalArgumentException {
		if (p_e_value == null) {
			throw new IllegalArgumentException("Level paramter ist empty");
		}
	...
	public void setConsoleLevel(java.util.logging.Level p_e_value) throws IllegalArgumentException {
		if (p_e_value == null) {
			throw new IllegalArgumentException("Console level paramter ist empty");
		}
	...
	public void setFileLevel(java.util.logging.Level p_e_value) throws IllegalArgumentException {
		if (p_e_value == null) {
			throw new IllegalArgumentException("File level paramter ist empty");
		}
	...
	public void setFilePath(String p_s_value) throws IllegalArgumentException, java.io.FileNotFoundException {
		...
		if ( (!p_s_value.contentEquals("%h" + de.forestj.lib.io.File.DIR)) && (!p_s_value.contentEquals("%t" + de.forestj.lib.io.File.DIR)) ) { 
	    	if (!de.forestj.lib.io.File.folderExists(p_s_value.replace("/", de.forestj.lib.io.File.DIR))) {
	...
	public LoggingConfig() {
		...
		this.s_filePath = "%t" + de.forestj.lib.io.File.DIR;
	...
	public LoggingConfig(String p_s_configFile) throws IllegalArgumentException, NullPointerException, java.io.FileNotFoundException {
		...
		if (de.forestj.lib.Helper.isStringEmpty(p_s_configFile)) {
			/* default value useConsole=true if we are not using a config file */
			this.b_useConsole = true;
		} else {
			if (!de.forestj.lib.io.File.exists(p_s_configFile)) {
			...
			for (int i = 0; i < a_configLines.size(); i++) {
				...
				if ( ( de.forestj.lib.Helper.isStringEmpty(s_line.trim()) ) || (!s_line.contains("=")) ) {
					continue;
				}
				...
				if (s_configName.contentEquals("useconsole")) {
					...
					if (s_configValue.toLowerCase().contentEquals("currentdirectory")) {
						this.setFilePath(java.nio.file.Paths.get("").toAbsolutePath().toString() + de.forestj.lib.io.File.DIR);
					} else {
	...
	private java.util.logging.Level stringLeveltoLoggingLevel(String p_s_level) throws NullPointerException {
		if (de.forestj.lib.Helper.isStringEmpty(p_s_level)) {
	...
	/**
	 * Converts a byte log level parameter to a matching de.forestj.lib.Global logging level
	 * 
	 * @param 	p_by_level					byte log level parameter
	 * @return								matching de.forestj.lib.Global logging level
	 * @throws	IllegalArgumentException	parameter is not set correctly
	 * @see									de.forestj.lib.Global
	 */
	public static String byteLevelToStringLoggingLevel(byte p_by_level) throws IllegalArgumentException {
		if (p_by_level == de.forestj.lib.Global.OFF) {
			return "OFF";
		} else if (p_by_level == de.forestj.lib.Global.SEVERE) {
			return "SEVERE";
		} else if (p_by_level == de.forestj.lib.Global.WARNING) {
			return "WARNING";
		} else if (p_by_level == de.forestj.lib.Global.INFO) {
			return "INFO";
		} else if (p_by_level == de.forestj.lib.Global.CONFIG) {
			return "CONFIG";
		} else if (p_by_level == de.forestj.lib.Global.FINE) {
			return "FINE";
		} else if (p_by_level == de.forestj.lib.Global.FINER) {
			return "FINER";
		} else if (p_by_level == de.forestj.lib.Global.FINEST) {
			return "FINEST";
		} else if (p_by_level == de.forestj.lib.Global.MASS) {
			return "MASS";
		} else if (p_by_level == de.forestj.lib.Global.ALL) {
			return "ALL";
		} else {
	...
	public static void initiateTestLogging() throws Exception {
		try {
			...
			de.forestj.lib.Global.get().by_logControl = de.forestj.lib.Global.OFF;
			de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.SEVERE;
			//de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.SEVERE + de.forestj.lib.Global.WARNING;
			//de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.SEVERE + de.forestj.lib.Global.WARNING + de.forestj.lib.Global.INFO;
			//de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.SEVERE + de.forestj.lib.Global.WARNING + de.forestj.lib.Global.INFO + de.forestj.lib.Global.CONFIG;
			//de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.SEVERE + de.forestj.lib.Global.WARNING + de.forestj.lib.Global.INFO + de.forestj.lib.Global.CONFIG + de.forestj.lib.Global.FINE;
			//de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.SEVERE + de.forestj.lib.Global.WARNING + de.forestj.lib.Global.INFO + de.forestj.lib.Global.CONFIG + de.forestj.lib.Global.FINE + de.forestj.lib.Global.FINER;
			//de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.ALMOST_ALL;
			//de.forestj.lib.Global.get().by_internalLogControl = de.forestj.lib.Global.ALL;
