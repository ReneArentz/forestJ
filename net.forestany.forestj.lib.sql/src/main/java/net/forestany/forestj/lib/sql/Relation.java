 ...
 */
public class Relation extends QueryAbstract {
	 ...
	 * column left
	 */
	public Column o_columnLeft = null;
	/**
	 * column right
	 */
	public Column o_columnRight = null;
	/**
	 * operator
	 */
	 ...
	 */
	public Relation(Query<?> p_o_query) throws IllegalArgumentException {
	 ...
	 * 
	 * @param p_o_query						query object with table and sql type information
	 * @param p_o_columnLeft				left side column of relation
	 * @param p_o_columnRight				right side column of relation
	 * @param p_s_operator					operator between both column, e.g. '=', '&lt;&gt;', '&gt;', ...
	 * @throws IllegalArgumentException		invalid database gateway value from query parameter object or invalid operator or filter operator value
	 */
	public Relation(Query<?> p_o_query, Column p_o_columnLeft, Column p_o_columnRight, String p_s_operator) throws IllegalArgumentException {
	 ...
	 * @throws IllegalArgumentException		invalid database gateway value from query parameter object or invalid operator or filter operator value
	 */
	public Relation(Query<?> p_o_query, Column p_o_columnLeft, Column p_o_columnRight, String p_s_operator, String p_s_filterOperator) throws IllegalArgumentException {
	 ...
	 * @throws IllegalArgumentException		invalid database gateway value from query parameter object or invalid operator or filter operator value
	 */
	public Relation(Query<?> p_o_query, Column p_o_columnLeft, Column p_o_columnRight, String p_s_operator, String p_s_filterOperator, boolean p_b_bracketStart) throws IllegalArgumentException {
	 ...
	 * @throws IllegalArgumentException		invalid database gateway value from query parameter object or invalid operator or filter operator value
	 */
	public Relation(Query<?> p_o_query, Column p_o_columnLeft, Column p_o_columnRight, String p_s_operator, String p_s_filterOperator, boolean p_b_bracketStart, boolean p_b_bracketEnd) throws IllegalArgumentException {
		super(p_o_query);
		
		if (p_o_columnLeft != null) {
			this.o_columnLeft = p_o_columnLeft;
		}
		
		if (p_o_columnRight != null) {
			this.o_columnRight = p_o_columnRight;
		}
		...
		if (p_b_bracketStart && p_b_bracketEnd) {
			throw new IllegalArgumentException("Cannot add '(' and ')' bracket in the same relation object");
		}
		...
		try {
			...
			switch (this.e_base) {
				...
				case NOSQLMDB:
					...
					if (this.b_bracketStart) {
						/* add '(' bracket */
						s_foo += "(";
					}
					
					/* add relation to query */
					s_foo += this.o_columnLeft.toString(false) + " " + this.s_operator + " " + this.o_columnRight.toString(false);
					
					if (this.b_bracketEnd) {
						/* add ')' bracket */
						s_foo += ")";
					}
				break;
			...
			s_foo = " >>>>> Relation class Exception: [" + o_exc.toString() + "] <<<<< ";
		}
