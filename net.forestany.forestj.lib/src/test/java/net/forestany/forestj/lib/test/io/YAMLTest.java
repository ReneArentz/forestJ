...
public class YAMLTest {
	...
	public void testYAML() {
		try {
			...
			String s_testDirectory = s_currentDirectory + net.forestany.forestj.lib.io.File.DIR + "testYAML" + net.forestany.forestj.lib.io.File.DIR;
	...
	private static void yamlValidate() throws Exception {
		String s_yamlSchemaFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "TestYAMLSchemaClassRootWithRef.yaml";
		String s_yamlFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "ValidateYAML.yaml";
		String s_invalidYamlFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "ValidateYAMLIsInvalid.yaml";
		
		assertTrue(
				new net.forestany.forestj.lib.io.YAML(s_yamlSchemaFile, 4).validateAgainstSchema(s_yamlFile),
		...
		try {
			assertFalse(
					new net.forestany.forestj.lib.io.YAML(s_yamlSchemaFile, 4).validateAgainstSchema(s_invalidYamlFile),
	...
	private static void yamlVirtualFiles() throws Exception {
		...
		net.forestany.forestj.lib.io.YAML o_yamlEmpty = new net.forestany.forestj.lib.io.YAML();
		net.forestany.forestj.lib.io.YAML.YAMLElement o_yamlSchema = o_yamlEmpty.new YAMLElement("Root");
		o_yamlSchema.setType("object");
		o_yamlSchema.setMappingClass("net.forestany.forestj.lib.test.sql.AllTypesRecord");
		
			net.forestany.forestj.lib.io.YAML.YAMLElement o_yamlElement = o_yamlEmpty.new YAMLElement("Id");
		...
		net.forestany.forestj.lib.io.YAML o_yaml = new net.forestany.forestj.lib.io.YAML(o_yamlSchema, 4);
		...
		net.forestany.forestj.lib.test.sql.AllTypesRecord o_recordIn = (net.forestany.forestj.lib.test.sql.AllTypesRecord)o_yaml.yamlDecode(a_fileLines);
		
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(o_recordOut, o_recordIn, o_yaml.getUsePropertyMethods()),
		...
		o_recordIn = (net.forestany.forestj.lib.test.sql.AllTypesRecord)o_yaml.yamlDecode(a_fileLines);
	...
	private static void yamlObject(String p_s_testDirectory, String p_s_fileNameSuffix) throws Exception {
		...
		net.forestany.forestj.lib.io.File o_fileSimpleClass = o_yaml.yamlEncode(o_recordOut, s_fileSimpleClass, true);
		
		net.forestany.forestj.lib.test.sql.AllTypesRecord o_recordIn = (net.forestany.forestj.lib.test.sql.AllTypesRecord)o_yaml.yamlDecode(s_fileSimpleClass);
	...
	private static void yamlClass(String p_s_testDirectory, String p_s_yamlSchemaFileName, String p_s_fileNameSuffix) throws Exception {
		...
		String s_yamlSchemaFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + p_s_yamlSchemaFileName;
		net.forestany.forestj.lib.io.YAML o_yaml = new net.forestany.forestj.lib.io.YAML(s_yamlSchemaFile, 4);
	...
	private static void yamlArray(String p_s_testDirectory, String p_s_yamlSchemaFileName, String p_s_fileNameSuffix) throws Exception {
		...
		if (p_s_yamlSchemaFileName.contentEquals("TestYAMLSchemaSimpleClassArray.yaml")) {
			@SuppressWarnings("unused")
			net.forestany.forestj.lib.io.File o_fileSimpleClass = o_yaml.yamlEncode(a_dataOut, s_fileSimpleClass, true);
		} else {
			@SuppressWarnings("unused")
			net.forestany.forestj.lib.io.File o_fileSimpleClass = o_yaml.yamlEncode(o_collectionOut, s_fileSimpleClass, true);
		}
		...
		if (!p_s_yamlSchemaFileName.contentEquals("TestYAMLSchemaSimpleClassArray.yaml")) {
			assertTrue(
					net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(o_collectionOut, o_collectionIn, o_yaml.getUsePropertyMethods()),
					"output object inner class collection is not equal to input object inner class collection"
					);
		}
		
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(a_dataOut, a_dataIn, o_yaml.getUsePropertyMethods()),
				"output object inner class array is not equal to input object inner class array"
				);
		
		for (int i = 0; i < a_dataOut.size(); i++) {
			assertTrue(
					net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(a_dataOut.get(i), a_dataIn.get(i), o_yaml.getUsePropertyMethods(), true),
	...
	private static void yamlComplex(String p_s_testDirectory, boolean p_b_classRoot, boolean p_b_listRoot, boolean p_b_classRootWithRef, boolean p_b_listRootWithRef, String p_s_fileNameSuffix) throws Exception {
		...
		if (p_b_classRoot) {
			s_yamlSchemaFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "TestYAMLSchemaClassRoot.yaml";
		} else if (p_b_listRoot) {
			s_yamlSchemaFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "TestYAMLSchemaListRoot.yaml";
		} else if (p_b_classRootWithRef) {
			s_yamlSchemaFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "TestYAMLSchemaClassRootWithRef.yaml";
		} else if (p_b_listRootWithRef) {
			s_yamlSchemaFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "TestYAMLSchemaListRootWithRef.yaml";
		}
		...
		if ( (p_b_classRoot) || (p_b_classRootWithRef) ) {
			@SuppressWarnings("unused")
			net.forestany.forestj.lib.io.File o_file = o_yaml.yamlEncode(o_shipOrderCollectionOut, s_file, true);
		} else {
			@SuppressWarnings("unused")
			net.forestany.forestj.lib.io.File o_file = o_yaml.yamlEncode(a_shipOrdersOut, s_file, true);
		}
		...
		if ( (p_b_classRoot) || (p_b_classRootWithRef) ) {
			assertTrue(
					net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(o_shipOrderCollectionOut, o_shipOrderCollectionIn, o_yaml.getUsePropertyMethods()),
					"output object inner class collection is not equal to input object inner class collection"
					);
		}
		
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(a_shipOrdersOut, a_shipOrdersIn, o_yaml.getUsePropertyMethods()),
				"output object inner class array is not equal to input object inner class array"
				);
		
		for (int i = 0; i < a_shipOrdersIn.size(); i++) {
			assertTrue(
					net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(a_shipOrdersOut.get(i), a_shipOrdersIn.get(i), o_yaml.getUsePropertyMethods(), true),
					"output object inner class array element object is not equal to input object inner class array element object"
					);
		...
		if (p_b_listRootWithRef) {
			s_file = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "TestYAMLPrimitiveArrayOneLine.yaml";
	...
	private static void yamlMultipleUseOfOneSchemaObject(String p_s_testDirectory) throws Exception {
		...
		String s_yamlSchemaFile = net.forestany.forestj.lib.io.File.getCurrentDirectory() + net.forestany.forestj.lib.io.File.DIR + "src" + net.forestany.forestj.lib.io.File.DIR + "test" + net.forestany.forestj.lib.io.File.DIR + "resources" + net.forestany.forestj.lib.io.File.DIR + "yaml" + net.forestany.forestj.lib.io.File.DIR + "TestYAMLSchemaSimpleClassObjectMultiReferences.yaml";
		net.forestany.forestj.lib.io.YAML o_yaml = new net.forestany.forestj.lib.io.YAML(s_yamlSchemaFile, 4);
		...
		o_yaml = new net.forestany.forestj.lib.io.YAML(s_yamlSchemaFile, 4);
		o_yaml.setUsePropertyMethods(true);
