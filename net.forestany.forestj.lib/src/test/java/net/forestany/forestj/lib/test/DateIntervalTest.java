...
public class DateIntervalTest {
	...
	public void testDateInterval() {
		net.forestany.forestj.lib.DateInterval o_dateInterval = null;
		
		try {
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("P1Y2M3DT4H5M6S");
			...
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("P1Y2M3D");
			...
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("PT4H5M6S");
		...
		try {
			o_dateInterval = new net.forestany.forestj.lib.DateInterval(null);
		...
		try {
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("");
		} catch (IllegalArgumentException o_exc) {
			assertTrue(
					o_exc.getMessage().contentEquals("String encoded date interval parameter is null or empty."),
					"wrong exception"
		...
		try {
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("PT2Mq");
		} catch (IllegalArgumentException o_exc) {
			assertTrue(
		...
		try {
			...
			o_dateInterval.setDateInterval(new net.forestany.forestj.lib.DateInterval("PT2M"));
		...
		try {
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("P1Y2M3DT4H5M6S", java.util.Locale.ENGLISH);
			...
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("P1Y2M3D", java.util.Locale.ENGLISH);
			...
			o_dateInterval = new net.forestany.forestj.lib.DateInterval("PT4H5M6S", java.util.Locale.ENGLISH);
