...
public class CSVTest {
	...
	public void testCSV() {
		try {
			...
			String s_file = s_currentDirectory + net.forestany.forestj.lib.io.File.DIR + "file.csv";
			net.forestany.forestj.lib.io.CSV o_csv = new net.forestany.forestj.lib.io.CSV(";", "*");
			
			if (net.forestany.forestj.lib.io.File.exists(s_file)) net.forestany.forestj.lib.io.File.deleteFile(s_file);
			assertFalse( net.forestany.forestj.lib.io.File.exists(s_file), "file[" + s_file + "] does exist" );
	...
	private static void csvClass(net.forestany.forestj.lib.io.CSV p_o_csv, String p_s_file) throws Exception {
		...
		net.forestany.forestj.lib.io.File o_file = p_o_csv.encodeCSV(o_recordOut, p_s_file, true, true);
		
		net.forestany.forestj.lib.test.sql.AllTypesRecord o_recordIn = new net.forestany.forestj.lib.test.sql.AllTypesRecord();
		p_o_csv.decodeCSV(p_s_file, o_recordIn);
		
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(o_recordOut, o_recordIn, p_o_csv.getUsePropertyMethods()),
	...
	private static void csvClassArray(net.forestany.forestj.lib.io.CSV p_o_csv, String p_s_file) throws Exception {
		java.util.List<net.forestany.forestj.lib.test.sql.AllTypesRecord> a_recordsOut = new java.util.ArrayList<net.forestany.forestj.lib.test.sql.AllTypesRecord>();
		
		net.forestany.forestj.lib.test.sql.AllTypesRecord o_recordTemp = new net.forestany.forestj.lib.test.sql.AllTypesRecord();
		...
		o_recordTemp = new net.forestany.forestj.lib.test.sql.AllTypesRecord();
		...
		net.forestany.forestj.lib.io.File o_file = p_o_csv.encodeCSV(a_recordsOut, p_s_file, true, true);
		
		java.util.List<net.forestany.forestj.lib.test.sql.AllTypesRecord> a_recordsIn = new java.util.ArrayList<net.forestany.forestj.lib.test.sql.AllTypesRecord>();
		p_o_csv.decodeCSV(p_s_file, a_recordsIn, net.forestany.forestj.lib.test.sql.AllTypesRecord.class);
		
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(a_recordsOut, a_recordsIn, p_o_csv.getUsePropertyMethods()),
	...
	private static void csvInnerClass(net.forestany.forestj.lib.io.CSV p_o_csv, String p_s_file) throws Exception {
		...
		net.forestany.forestj.lib.io.File o_file = p_o_csv.encodeCSV(o_shipItemOut, p_s_file, true, true);
		
		Data.ShipItem o_shipItemIn = o_data.new ShipItem();
		p_o_csv.decodeCSV(p_s_file, o_shipItemIn);
		
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(o_shipItemOut, o_shipItemIn, p_o_csv.getUsePropertyMethods()),
	...
	private static void csvInnerClassArray(net.forestany.forestj.lib.io.CSV p_o_csv, String p_s_file) throws Exception {
		Data o_data = new Data();
		...
		net.forestany.forestj.lib.io.File o_file = p_o_csv.encodeCSV(a_dataOut, p_s_file, true, true);
		...
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(a_dataOut, a_dataIn, p_o_csv.getUsePropertyMethods()),
	...
	private static void csvOtherInnerClass(net.forestany.forestj.lib.io.CSV p_o_csv, String p_s_file) throws Exception {
		Data o_data = new Data();
		...
		net.forestany.forestj.lib.io.File o_file = p_o_csv.encodeCSV(o_shipOrderOut, p_s_file, true, true);
		
		Data.ShipOrder o_shipOrderIn = o_data.new ShipOrder();
		p_o_csv.decodeCSV(p_s_file, o_shipOrderIn);
		
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(o_shipOrderOut, o_shipOrderIn, p_o_csv.getUsePropertyMethods()),
	...
	private static void csvOtherInnerClassArray(net.forestany.forestj.lib.io.CSV p_o_csv, String p_s_file) throws Exception {
		Data o_data = new Data();
		...
		net.forestany.forestj.lib.io.File o_file = p_o_csv.encodeCSV(a_dataShipItemOut, p_s_file, true, true);
		...
		assertTrue(
				net.forestany.forestj.lib.Helper.objectsEqualUsingReflections(a_dataShipItemOut, a_dataShipItemIn, p_o_csv.getUsePropertyMethods()),
