...
public class StateMachineTest {
	...
	public void testStateMachineSimple() {
		try {
			...
			String s_testDirectory = s_currentDirectory + net.forestany.forestj.lib.io.File.DIR;
			String s_file = s_testDirectory + "StateMachineSimple.log";
			
			if (net.forestany.forestj.lib.io.File.exists(s_file)) {
			...
			o_stateMachine.addTransition("FINALSTATE", net.forestany.forestj.lib.StateMachine.EXIT, net.forestany.forestj.lib.StateMachine.EXIT);
			...
			o_stateMachine.addStateMethod(o_stateMachine.new StateMethodContainer(
				...
				(java.util.List<Object> p_a_genericList) -> {
					...
					int i_random = net.forestany.forestj.lib.Helper.randomIntegerRange(1, 100);
					
					if ( (i_random >= 26) && (i_random <= 50) ) {
						((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("BEGINSTATE");
						return "START";
					} else {
						((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("BEGINSTATE - IDLE");
			...
			o_stateMachine.addStateMethod(o_stateMachine.new StateMethodContainer(
				"STATE1",
				(java.util.List<Object> p_a_genericList) -> {
					((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("STATE1");
					p_a_genericList.set(1, ((int) p_a_genericList.get(1)) + 1);
					return "TRANSFER";
				}
			));
			...
			o_stateMachine.addStateMethod(o_stateMachine.new StateMethodContainer(
				"STATE2",
				(java.util.List<Object> p_a_genericList) -> {
					((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("STATE2");
					p_a_genericList.set(1, ((int) p_a_genericList.get(1)) + 1);
					return "TRANSFER";
				}
			));
			...
			o_stateMachine.addStateMethod(o_stateMachine.new StateMethodContainer(
				"STATE3",
				(java.util.List<Object> p_a_genericList) -> {
					((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("STATE3");
					p_a_genericList.set(1, ((int) p_a_genericList.get(1)) + 1);
					return "TRANSFER";
				}
			));
			...
			o_stateMachine.addStateMethod(o_stateMachine.new StateMethodContainer(
				"FINALSTATE",
				(java.util.List<Object> p_a_genericList) -> {
					((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("FINALSTATE");
					p_a_genericList.set(1, ((int) p_a_genericList.get(1)) + 1);
			...
			net.forestany.forestj.lib.io.File o_checkFile = new net.forestany.forestj.lib.io.File(s_file);
	...
	public void testStateMachineTimer() {
		try {
			...
			StateMachineTimerTask o_task = new StateMachineTimerTask(new net.forestany.forestj.lib.DateInterval("PT1S"));
			net.forestany.forestj.lib.Timer o_timer = new net.forestany.forestj.lib.Timer(o_task);
	...
	private class StateMachineTimerTask extends net.forestany.forestj.lib.TimerTask {
		/* Fields */
		
		private net.forestany.forestj.lib.StateMachine o_stateMachine;
		...
		public StateMachineTimerTask(net.forestany.forestj.lib.DateInterval p_o_interval) {
			super(p_o_interval);
			this.buildStateMachine();
		}
		
		public StateMachineTimerTask(net.forestany.forestj.lib.DateInterval p_o_interval, java.time.LocalTime p_o_startTime) {
		...
		private void buildStateMachine() {
			...
			String s_testDirectory = s_currentDirectory + net.forestany.forestj.lib.io.File.DIR;
			String s_file = s_testDirectory + "StateMachineTimer.log";
			net.forestany.forestj.lib.io.File o_file = null;
			...
			this.o_stateMachine = new net.forestany.forestj.lib.StateMachine(a_states, a_returnCodes);
			
			this.o_stateMachine.addTransition("RED", "CAR_CONTACT", "RED_YELLOW");
			this.o_stateMachine.addTransition("RED", "CIRCLE_END", "RED");
			this.o_stateMachine.addTransition("RED", net.forestany.forestj.lib.StateMachine.EXIT, net.forestany.forestj.lib.StateMachine.EXIT);
			...
			this.o_stateMachine.addStateMethod(this.o_stateMachine.new StateMethodContainer(
				...
				(java.util.List<Object> p_a_genericList) -> {
					...
					if ( (i_random >= 1) && (i_random <= 40) ) {
						((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("RED - CIRCLE_END");
						p_a_genericList.set(2, ((int) p_a_genericList.get(2)) + 1);
						return "CIRCLE_END";
					} else if ( (i_random >= 41) && (i_random <= 75) ) {
						((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("RED - CAR_CONTACT");
						return "CAR_CONTACT";
					} else {
						((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("RED - EXIT");
						return "EXIT";
					}
				}
			));
			...
			this.o_stateMachine.addStateMethod(this.o_stateMachine.new StateMethodContainer(
				"RED_YELLOW",
				(java.util.List<Object> p_a_genericList) -> {
					((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("RED_YELLOW");
					p_a_genericList.set(1, ((int) p_a_genericList.get(1)) + 1);
					return "CIRCLE_END";
				}
			));
			...
			this.o_stateMachine.addStateMethod(this.o_stateMachine.new StateMethodContainer(
				"GREEN",
				(java.util.List<Object> p_a_genericList) -> {
					((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("GREEN");
					p_a_genericList.set(1, ((int) p_a_genericList.get(1)) + 1);
					return "CIRCLE_END";
				}
			));
			...
			this.o_stateMachine.addStateMethod(this.o_stateMachine.new StateMethodContainer(
				"YELLOW",
				(java.util.List<Object> p_a_genericList) -> {
					((net.forestany.forestj.lib.io.File)p_a_genericList.get(0)).appendLine("YELLOW");
					p_a_genericList.set(1, ((int) p_a_genericList.get(1)) + 1);
					return "CIRCLE_END";
				}
			));
			...
			/* define init values */
			this.s_returnCode = net.forestany.forestj.lib.StateMachine.EXIT;
		...
		@Override public void runTimerTask() throws Exception {
			...
			if (this.s_returnCode.contentEquals(net.forestany.forestj.lib.StateMachine.EXIT)) {
	    		this.cancel();
	    	}
