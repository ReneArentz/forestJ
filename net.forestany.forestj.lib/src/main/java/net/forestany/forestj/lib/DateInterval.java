...
public class DateInterval {
	 ...
	 * set locale setting
	 * 
	 * @param p_o_locale				locale instance
	 ...
	 * @throws 	IllegalArgumentException		parameter is null or does not match date interval format
	 * @see		Helper
	 */
	 ...
	 * @param	p_a_definitions				direct definition of date interval words
	 * 										must contain 6 elements for 'year', 'month', 'day', 'hour', 'minute', 'second'
	 * @return	String
	 * @throws IllegalArgumentException		parameter array must contain 6 elements
	 * @see		String
	 */
