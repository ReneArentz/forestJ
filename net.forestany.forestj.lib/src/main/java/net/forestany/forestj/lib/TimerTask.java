...
public abstract class TimerTask extends java.util.TimerTask {
	 ...
	 */
	public net.forestany.forestj.lib.DateInterval getInterval() {
		return this.o_interval;
	}
	
	/**
	 * get show exception flag
	 * 
	 * @return boolean
	 */
	...
	/**
	 * set show exception flag
	 * 
	 * @param p_b_value		true - show exception stack trace, false - exceptions are hidden
	 */
	 ...
	 */
	public TimerTask(net.forestany.forestj.lib.DateInterval p_o_interval) {
	 ...
	 */
	public TimerTask(net.forestany.forestj.lib.DateInterval p_o_interval, java.time.LocalTime p_o_startTime) {
		...
		this.b_showException = false;
												...
												net.forestany.forestj.lib.Global.ilogConfig("Created TimerTask with interval '" + p_o_interval + "' and start time '" + p_o_startTime + "'");
	}
	...
	public void clearExcludeWeekdays() {
		this.a_excludeWeekdays.clear();
												net.forestany.forestj.lib.Global.ilogConfig("Exclude weekday settings cleared");
	}
	 ...
	 *  @throws Exception		any exception which might happen during execution of timer task
	 */
			...
			try {
				...
				if (this.b_showException) {
					net.forestany.forestj.lib.Global.logException(o_exc);
													...
													net.forestany.forestj.lib.Global.ilogFinest("Weekday '" + o_dayOfWeek + "' is excluded");
		}
	}
}
