 ...
 *
 */
public abstract class FileSystemWatcher extends net.forestany.forestj.lib.TimerTask {
	
	/* Fields */
	
	private String s_directory;
	private java.util.List<ListingElement> a_files;
	private net.forestany.forestj.lib.Timer o_timerObject;
	 ...
	 * set recursive flag
	 * 
	 * @param p_b_value		true - 	iterate all files in observing directory and it's children
	 */
	public void setRecursive(boolean p_b_value) {
		this.b_recursive = p_b_value;
												net.forestany.forestj.lib.Global.ilogConfig("updated recursive to '" + p_b_value + "'");
	}
	
	/**
	 * set create flag
	 * 
	 * @param p_b_value		true - observe create events
	 */
	public void setCreate(boolean p_b_value) {
		this.b_create = p_b_value;
												net.forestany.forestj.lib.Global.ilogConfig("updated create to '" + p_b_value + "'");
	}
	
	/**
	 * set change flag
	 * 
	 * @param p_b_value		true - observe change events
	 */
	public void setChange(boolean p_b_value) {
		this.b_change = p_b_value;
												net.forestany.forestj.lib.Global.ilogConfig("updated change to '" + p_b_value + "'");
	}
	
	/**
	 * set delete flag
	 * 
	 * @param p_b_value		true - observe delete events
	 */
	public void setDelete(boolean p_b_value) {
		this.b_delete = p_b_value;
												net.forestany.forestj.lib.Global.ilogConfig("updated delete to '" + p_b_value + "'");
	}
	
	/**
	 * set access flag
	 * 
	 * @param p_b_value		true - observe access events
	 */
	public void setAccess(boolean p_b_value) {
		this.b_access = p_b_value;
												net.forestany.forestj.lib.Global.ilogConfig("updated access to '" + p_b_value + "'");
	}
	
	/**
	 * set file extension filter
	 * 
	 * @param p_s_value		file extension filter value
	 */
	public void setFileExtensionFilter(String p_s_value) {
		this.s_fileExtensionFilter = p_s_value;
												net.forestany.forestj.lib.Global.ilogConfig("updated file extension filter to '" + p_s_value + "'");
	}
	 ...
	 * @see net.forestany.forestj.lib.DateInterval
	 */
	public FileSystemWatcher(String p_s_directory, net.forestany.forestj.lib.DateInterval p_o_interval) throws IllegalArgumentException {
	 ...
	 */
	public FileSystemWatcher(String p_s_directory, net.forestany.forestj.lib.DateInterval p_o_interval, java.time.LocalTime p_o_startTime) throws IllegalArgumentException {
		...
		if (this.o_timerObject == null) {
			...
			for (ListingElement o_listingElement : File.listDirectory(this.s_directory, this.b_recursive)) {
				...
				this.a_files.add(o_listingElement);
														net.forestany.forestj.lib.Global.ilogFinest("Added file on start of file system watcher to have it's initial state [" + o_listingElement.getFullName() + "]");
			}
			
			/* create timer object and start timer */
			this.o_timerObject = new net.forestany.forestj.lib.Timer(this);
			this.o_timerObject.startTimer();
													net.forestany.forestj.lib.Global.ilogFiner("File system watcher has been started");
		} else {
													net.forestany.forestj.lib.Global.ilog("File system watcher already has been started - no action has been done");
		}
	}
	...
	public void stop() {
		...
		if (this.o_timerObject != null) {
			...
			this.o_timerObject = null;
													net.forestany.forestj.lib.Global.ilogFiner("File system watcher has been stopped");
		} else {
													net.forestany.forestj.lib.Global.ilog("File system watcher already has been stopped or never started - no action has been done");
		}
	}
	...
	public void runTimerTask() throws java.nio.file.InvalidPathException, java.io.IOException {
			...
			if (b_found) { /* file still exists */
				...
				if (this.b_change) {
					if (o_compareListingElement.getLastModifiedTime().compareTo(o_listingElement.getLastModifiedTime()) > 0) {
						/* fire change event */
						net.forestany.forestj.lib.Global.ilogFinest("fire change event '" + o_compareListingElement.getFullName() + "'");
				...
				if (this.b_access) {
					if (o_compareListingElement.getLastAccessTime().compareTo(o_listingElement.getLastAccessTime()) > 0) {
						/* fire access event */
						net.forestany.forestj.lib.Global.ilogFinest("fire access event '" + o_compareListingElement.getFullName() + "'");
				...
				if (this.b_delete) {
					/* fire delete event */
					net.forestany.forestj.lib.Global.ilogFinest("fire delete event '" + o_listingElement.getFullName() + "'");
		...
		for (ListingElement o_listingElement : a_currentFiles) {
			...
			if ( (!b_found) && (this.b_create) ) {
				/* fire create event */
				net.forestany.forestj.lib.Global.ilogFinest("fire create event '" + o_listingElement.getFullName() + "'");
