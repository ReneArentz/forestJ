...
public class CSV {
	...
	/**
	 * string list of allowed types for CSV encoding/decoding
	 */
	...
	public void setDelimiter(String p_s_value) throws IllegalArgumentException {
		...
		net.forestany.forestj.lib.Global.ilogConfig("updated delimiter to '" + this.s_delimiter + "'");
	}
	 ...
	 * set array delimiter
	 * 
	 * @param p_s_value						array delimiter value
	 * @throws IllegalArgumentException		must have length of '1'
	 */
	public void setArrayDelimiter(String p_s_value) throws IllegalArgumentException {
		...
		net.forestany.forestj.lib.Global.ilogConfig("updated array delimiter to '" + this.s_arrayDelimiter + "'");
	}
	...
	/**
	 * get flag for return array element as null and not zero
	 * 
	 * @return boolean
	 */
	...
	/**
	 * set flag for return array element as null and not zero
	 * @param p_b_value determine if you want to return empty values as null or 0
	 */
	...
	/**
	 * set charset instance
	 * 
	 * @param p_o_charset				charset instance parameter
	...
	public void setCharset(java.nio.charset.Charset p_o_charset) throws NullPointerException {
		...
		net.forestany.forestj.lib.Global.ilogConfig("updated charset to '" + this.o_charset.toString() + "'");
	}
	 ...
	 */
	public CSV() throws IllegalArgumentException {
		this(",", "~");
	}
	 ...
	 * @return net.forestany.forestj.lib.io.File object
	 * @throws java.io.IOException								exception creating csv file or replacing content of csv file
	 * @throws NoSuchFieldException								could not retrieve field type by field name
	 * @throws NoSuchMethodException							could not retrieve method by method name
	 * @throws IllegalAccessException							could not invoke method, access violation
	...
	public File encodeCSV(Object p_o_object, String p_s_csvFile, boolean p_b_printHeader, boolean p_b_overwrite) throws java.io.IOException, NoSuchFieldException, NoSuchMethodException, IllegalAccessException, java.lang.reflect.InvocationTargetException, IllegalArgumentException {
		...
		/* open (new) file */
		net.forestany.forestj.lib.io.File o_file = new net.forestany.forestj.lib.io.File(p_s_csvFile, this.o_charset, !p_b_overwrite, net.forestany.forestj.lib.io.File.NEWLINE);
		...
		for (java.lang.reflect.Field o_field : p_o_object.getClass().getDeclaredFields()) {
			...
			if (o_field.getType().getTypeName().contains("java.util.List")) {
		        ...
		        Class<?> o_type = (Class<?>)stringListType.getActualTypeArguments()[0];
		        										...
		        										net.forestany.forestj.lib.Global.ilogFiner("iterate all fields - array element type '" + o_type.getTypeName() + "'");
		        ...
		        if (!a_allowedTypes.contains(o_type.getTypeName())) {
		        											net.forestany.forestj.lib.Global.ilogFinest("skip field - type '" + o_type.getTypeName() + "' not allowed");
					continue;
		        }
				...
				if (!a_allowedTypes.contains(o_field.getType().getTypeName().substring(0, o_field.getType().getTypeName().length() - 2))) {
															net.forestany.forestj.lib.Global.ilogFinest("skip array field - type '" + o_field.getType().getTypeName() + "' not allowed");
					continue;
	        	}
														...
														net.forestany.forestj.lib.Global.ilogFinest("skip field - type '" + o_field.getType().getTypeName() + "' not allowed");
				continue;
														...
														net.forestany.forestj.lib.Global.ilogFinest("skip field - field is static or final");
				continue;
			}
		...
		for (java.lang.reflect.Field o_field : p_o_object.getClass().getDeclaredFields()) {
			...
			if (o_field.getType().getTypeName().contains("java.util.List")) {
		        ...
		        if (!a_allowedTypes.contains(s_arrayType)) {
															net.forestany.forestj.lib.Global.ilogFinest("skip field - type '" + s_arrayType + "' not allowed");
					continue;
		        }
			} else if (o_field.getType().getTypeName().endsWith("[]")) { /* if field array type of parameter object is not contained in the list of allowed types, skip this field */
				if (!a_allowedTypes.contains(o_field.getType().getTypeName().substring(0, o_field.getType().getTypeName().length() - 2))) {
	...
	private String objectValueToString(Object p_o_object, String p_s_type) throws IllegalArgumentException {
		...
		if (p_o_object != null) {
			...
			if (p_s_type.contentEquals("java.lang.String")) {
				...
				s_foo = net.forestany.forestj.lib.Helper.utilDateToISO8601UTC(o_date);
				...
				s_foo = net.forestany.forestj.lib.Helper.toISO8601UTC(o_localDateTime);
				...
				s_foo = net.forestany.forestj.lib.Helper.toISO8601UTC(java.time.LocalDateTime.of(o_localDate, java.time.LocalTime.of(0, 0)));
				...
				s_foo = net.forestany.forestj.lib.Helper.toISO8601UTC(java.time.LocalDateTime.of(java.time.LocalDate.of(1900, 1, 1), o_localTime));
			} else {
	...
	public void decodeCSV(String p_s_csvFile, Object p_o_object, Class<?> p_o_arrayElementClass) throws IllegalArgumentException, java.io.IOException, NoSuchFieldException, NoSuchMethodException, java.text.ParseException, java.time.DateTimeException, IllegalAccessException, InstantiationException, java.lang.reflect.InvocationTargetException, ClassNotFoundException {
		...
		/* open csv file */
		net.forestany.forestj.lib.io.File o_file = new net.forestany.forestj.lib.io.File(p_s_csvFile, this.o_charset, false, net.forestany.forestj.lib.io.File.NEWLINE);
	...
	private void decodeCSVFile(String p_s_csvContent, Object p_o_object, Class<?> p_o_arrayElementClass) throws NoSuchFieldException, NoSuchMethodException, java.lang.reflect.InvocationTargetException, IllegalAccessException, InstantiationException, java.text.ParseException, java.time.DateTimeException, ClassNotFoundException {
		...
		if (a_csvLines.length > 0) {
			...
			String[] a_fieldNames = s_headerLine.split(this.s_delimiter);
													...
													net.forestany.forestj.lib.Global.ilogFiner("Generated header line:\t" + s_headerLine);
