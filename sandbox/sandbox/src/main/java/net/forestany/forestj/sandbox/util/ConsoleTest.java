...
public class ConsoleTest {
	...
	public static void testConsoleProgressBar() throws Exception {
    	...
    	net.forestany.forestj.lib.ConsoleProgressBar o_progressBar_1 = new net.forestany.forestj.lib.ConsoleProgressBar();
		...
		net.forestany.forestj.lib.ConsoleProgressBar o_progressBar_2 = new net.forestany.forestj.lib.ConsoleProgressBar(18);
		...
		net.forestany.forestj.lib.ConsoleProgressBar o_progressBar_3 = new net.forestany.forestj.lib.ConsoleProgressBar((long)75, 18);
		...
		net.forestany.forestj.lib.ConsoleProgressBar o_progressBar_4 = new net.forestany.forestj.lib.ConsoleProgressBar((long)75, 18, 10);
		...
		net.forestany.forestj.lib.ConsoleProgressBar o_progressBar_5 = new net.forestany.forestj.lib.ConsoleProgressBar(10, 8);
		...
		net.forestany.forestj.lib.ConsoleProgressBar o_progressBar_6 = new net.forestany.forestj.lib.ConsoleProgressBar((long)75, 18, 10, 12);
