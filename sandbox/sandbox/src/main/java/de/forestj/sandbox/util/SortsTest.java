...
public class SortsTest {
    ...
    private static void testSortsList(boolean p_b_unique, int p_i_amount, boolean p_b_selection, boolean p_b_insertion, boolean p_b_bubble, boolean p_b_heap, boolean p_b_merge, boolean p_b_quick) throws Exception {
		...
		de.forestj.lib.Global.log("Generating '" + String.format("%,d", p_i_amount) + "' " + ((p_b_unique) ? "unique" : "random") + " values . . . ");
		...
		if (p_b_unique) {
			...
			for (int i = 1; i <= p_i_amount; i++) {
				a_list.add(de.forestj.lib.Helper.randomIntegerRange(1, p_i_amount));
			}
		}
		
		de.forestj.lib.ConsoleProgressBar o_progressBar = new de.forestj.lib.ConsoleProgressBar(4, 4);
		
		de.forestj.lib.Sorts.IDelegate itf_delegate = new de.forestj.lib.Sorts.IDelegate() { 
		...
		if (p_b_selection) {
			...
			de.forestj.lib.Sorts.selectionSort(a_list, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_insertion) {
			...
			de.forestj.lib.Sorts.insertionSort(a_list, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_bubble) {
			...
			de.forestj.lib.Sorts.bubbleSort(a_list, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_heap) {
			...
			de.forestj.lib.Sorts.heapSort(a_list, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_merge) {
			...
			de.forestj.lib.Sorts.mergeSort(a_list, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_quick) {
			...
			de.forestj.lib.Sorts.quickSort(a_list, itf_delegate);
			o_progressBar.close();
	...
	private static void testSortsMap(boolean p_b_unique, int p_i_amount, boolean p_b_selection, boolean p_b_insertion, boolean p_b_bubble, boolean p_b_heap, boolean p_b_merge, boolean p_b_quick, boolean p_b_sortByValue) throws Exception {
		...
		de.forestj.lib.Global.log("Generating '" + String.format("%,d", p_i_amount) + "' " + ((p_b_unique) ? "unique" : "random") + " values - sort by value: " + p_b_sortByValue + " . . . ");
		...
		de.forestj.lib.ConsoleProgressBar o_progressBar = new de.forestj.lib.ConsoleProgressBar();
		...
		if (p_b_selection) {
			...
			o_progressBar.init("SelectionSort . . .", "Done.");
			a_return = de.forestj.lib.Sorts.selectionSort(a_map, p_b_sortByValue, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_insertion) {
			...
			o_progressBar.init("InsertionSort . . .", "Done.");
			a_return = de.forestj.lib.Sorts.insertionSort(a_map, p_b_sortByValue, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_bubble) {
			...
			o_progressBar.init("BubbleSort . . .", "Done.");
			a_return = de.forestj.lib.Sorts.bubbleSort(a_map, p_b_sortByValue, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_heap) {
			...
			a_return = de.forestj.lib.Sorts.heapSort(a_map, p_b_sortByValue, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_merge) {
			...
			a_return = de.forestj.lib.Sorts.mergeSort(a_map, p_b_sortByValue, itf_delegate);
			o_progressBar.close();
		...
		if (p_b_quick) {
			...
			a_return = de.forestj.lib.Sorts.quickSort(a_map, p_b_sortByValue, itf_delegate);
			o_progressBar.close();
