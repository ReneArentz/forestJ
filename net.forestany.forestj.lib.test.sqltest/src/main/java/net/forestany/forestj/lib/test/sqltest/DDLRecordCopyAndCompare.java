...
/**
 * record class to test copy and compare functionalities
 */
public class DDLRecordCopyAndCompare extends net.forestany.forestj.lib.sql.Record<DDLRecordCopyAndCompare> {
	 ...
	 */
	public DDLRecordCopyAndCompare() throws NullPointerException, IllegalArgumentException, NoSuchFieldException {
		super();
	}
	
	protected void init() {
		this.RecordImageClass = DDLRecordCopyAndCompare.class;
		this.Table = "sys_forestj_testddl3";
		this.Primary.add("Id");
