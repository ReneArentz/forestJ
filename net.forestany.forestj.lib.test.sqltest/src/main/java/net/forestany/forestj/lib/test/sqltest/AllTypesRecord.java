...
/**
 * record class to test all types
 */
public class AllTypesRecord extends net.forestany.forestj.lib.sql.Record<AllTypesRecord> {
	 ...
	 */
	public AllTypesRecord() throws NullPointerException, IllegalArgumentException, NoSuchFieldException {
		super();
	}
	
	protected void init() {
		this.RecordImageClass = AllTypesRecord.class;
		this.Table = "sys_forestj_alltypes";
		this.Primary.add("Id");
